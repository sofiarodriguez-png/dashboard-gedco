"""
Script para actualizar automáticamente el dashboard GEDCO y subirlo a GitHub
"""
import subprocess
import sys
...
print("=" * 80)
print(f"ACTUALIZACIÓN AUTOMÁTICA DEL DASHBOARD - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
print("=" * 80)
